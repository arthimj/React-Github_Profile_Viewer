...
class UserProfile extends Component {
  /**
   * Defaults the first profile that is fetched from the API.
   * @returns {undefined}
   */
  componentWillMount() {
          ...
          <ul className="material-list-icon mdl-list">
            <li className="mdl-list__item">
              <span className="mdl-list__item-primary-content">
                ...
                <span className="mdl-badge" data-badge={profile.public_repos}>
                  Repositories
                </span>
              </span>
            </li>
            <li className="mdl-list__item">
              <span className="mdl-list__item-primary-content">
                ...
                <span className="mdl-badge" data-badge={profile.public_gists}>
                  Gists
                </span>
              </span>
            </li>
            <li className="mdl-list__item">
              <span className="mdl-list__item-primary-content">
                ...
                <span className="mdl-badge" data-badge={profile.followers}>
                  Followers
                </span>
              </span>
            </li>
